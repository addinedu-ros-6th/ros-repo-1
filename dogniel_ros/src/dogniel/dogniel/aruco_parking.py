    ...
    def turn_theta(self):
        ...
        if self.step_1 == False:
            ...
            if self.theta > 0:
                ...
                self.msg.angular.z = self.w * self.pm
                ...
                print(self.pm)
                print(self.msg)
                self.get_logger().info(f"Rotating robot_1 by {self.theta} radians. {round(self.g - self.right_motor, 2)}")
    ...
    def go_x(self):
        if self.step_2 == False:
            ...
            if self.step_2_1 == False:
                self.g = alpha * 28 + self.right_motor
                print(self.g)
                print(self.right_motor)
                self.step_2_1 = True
...
#
        ...
        if self.step_3 == False:
            ...
            if self.pm > 0:
                if self.step_3_1 == False:
                    self.g = self.left_motor + 2.99 * alpha + 1.0
                    self.step_3_1 = True
                    print(self.g)
                    print(self.left_motor)

                self.msg.linear.x = 0.0
                self.msg.angular.z = -self.pm * self.w
                self.publisher_.publish(self.msg)
                ...
                if self.step_3_1 == False:
                    self.g = self.right_motor + 2.99 * alpha + 1.0
                    self.step_3_1 = True
    ...
    def go_remain_30cm(self):
        if self.step_4 == False:
            alpha = (self.z -0.3)
            if self. pm > 0:
                if self.step_4_1 == False:
                    self.g = alpha * 0.27  + self.right_motor
                    self.step_4_1 = True
            elif self.pm <0:
                if self.step_4_1 == False:
                    self.g = alpha * 0.27  + self.left_motor
                    self.step_4_1 = True
            if alpha > 0:
